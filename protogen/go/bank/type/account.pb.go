...
const file_proto_bank_type_account_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/bank/type/account.proto\x12\tbank.type\x1a\x1cproto/google/type/date.proto\"?\n" +
	"\x15CurrentBalanceRequest\x12&\n" +
	"\x0eaccount_number\x18\x01 \x01(\tR\x0eaccount_number\"\x91\x01\n" +
	...
	"\flast_updated\x18\x03 \x01(\v2\x11.google.type.DateR\flast_updatedB<Z:github.com/raghav-gkmit/go-proto-buf/protogen/go/bank/typeb\x06proto3"
...
var file_proto_bank_type_account_proto_goTypes = []any{
	(*CurrentBalanceRequest)(nil),  // 0: bank.type.CurrentBalanceRequest
	(*CurrentBalanceResponse)(nil), // 1: bank.type.CurrentBalanceResponse
	(*google.Date)(nil),            // 2: google.type.Date
}
var file_proto_bank_type_account_proto_depIdxs = []int32{
	2, // 0: bank.type.CurrentBalanceResponse.last_updated:type_name -> google.type.Date
