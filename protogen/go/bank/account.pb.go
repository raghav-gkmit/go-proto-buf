...
type CurrentBalanceRequest struct {
	...
	AccountNumber string                 `protobuf:"bytes,1,opt,name=account_number,json=account_umber,proto3" json:"account_number,omitempty"`
...
type CurrentBalanceResponse struct {
	...
	LastUpdated   *google.Date           `protobuf:"bytes,3,opt,name=last_updated,proto3" json:"last_updated,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CurrentBalanceResponse) GetBalance() float64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
func (x *CurrentBalanceResponse) GetLastUpdated() *google.Date {
	if x != nil {
...
const file_proto_bank_type_account_proto_rawDesc = "" +
	...
	"\x0eaccount_number\x18\x01 \x01(\tR\raccount_umber\"\x91\x01\n" +
	...
	"\flast_updated\x18\x03 \x01(\v2\x11.google.type.DateR\flast_updatedB7Z5github.com/raghav-gkmit/go-proto-buf/protogen/go/bankb\x06proto3"
...
var (
	file_proto_bank_type_account_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_proto_bank_type_account_proto_goTypes  = []any{
...
var file_proto_bank_type_account_proto_depIdxs = []int32{
	2, // 0: bank.CurrentBalanceResponse.last_updated:type_name -> google.type.Date
